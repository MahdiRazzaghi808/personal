...
export const myProjects = [
    { id: 1, title: "فروشگاه", image: reactShop, technologies: ["react", "css"], link: "https://shop-react-css.iran.liara.run/", explain: "", active: "active" },
    { id: 2, title: "فرم ثبت نام", image: register, technologies: ["react", "css"], link: "https://register-react-css.iran.liara.run/SingIn", explain: "", active: "active" },
    { id: 3, title: "کوئیز اپ", image: quizApp, technologies: ["react", "bootstrap"], link: "https://mahdirazzaghi808.github.io/quizApp-react-bootstrap/", explain: "", active: "active" },
