...
const AboutMe = () => {
    return (
        <div id="about" className={styles.aboutMe}>
            <div  className={styles.imageWrapper} data-aos="fade-left" data-aos-duration="1000" data-aos-easing="linear">
                <img src={aboutImage} alt="about" />
            </div>
            <div className={styles.explain} data-aos="fade-right" data-aos-duration="1000" data-aos-easing="linear">
                <h2>درباره من</h2>
